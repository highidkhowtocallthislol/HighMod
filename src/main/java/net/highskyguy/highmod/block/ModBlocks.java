...
public class ModBlocks {
    ...
    public static final Block POTTED_DAHLIA = Registry.register(Registries.BLOCK, new Identifier(HighMod.MOD_ID, "potted_dahlia"),
    ...
    public static void registerModBlocks() {
        HighMod.LOGGER.info("Registering ModBlocks for " + HighMod.MOD_ID);
    }
}